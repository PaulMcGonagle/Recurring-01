...
namespace Scheduler.Test.YearMonthTest
{
    public class VerifyMonthCountSetter
    {
        ...
        public void ThenAnExceptionIsThrownAsExpected(bool expectedIsExceptionThrown)
        {
            if (expectedIsExceptionThrown)
                Assert.Throws<System.ArgumentOutOfRangeException>(() => new YearMonth() { MonthCount = monthCount });
        }
    }
    ...
    public class VerifyYearSetter
    {
        ...
        {
            if (expectedIsExceptionThrown)
                Assert.Throws<System.ArgumentOutOfRangeException>(() => new YearMonth() { Year = _sutYear, Month = _sutMonth });
        }
    }

    public class VerifyYearAndMonth
    {
        private Scheduler.YearMonth _sut;
        ...
        public void Execute()
        {
            this.WithExamples(new ExampleTable("SUT", "Expected Year", "Expected Month")
            {
                {   new Scheduler.YearMonth() { Year = 2016, Month = YearMonth.MonthValue.January },   2016, YearMonth.MonthValue.January},
                {   new Scheduler.YearMonth() { Year = 9999, Month = YearMonth.MonthValue.December },   9999, YearMonth.MonthValue.December},
                {   new Scheduler.YearMonth() { Year = 1000, Month = YearMonth.MonthValue.January },   1000, YearMonth.MonthValue.January},
            })
                .BDDfy();
        }
    ...
    public class VerifyDaysInMonth
    {
        ...
        public void Execute()
        {
            this.WithExamples(new ExampleTable("SUT", "Expected DaysInMonth")
                {
                    {   new Scheduler.YearMonth() { Year = YearMonth.YearLimit.Lower, Month = YearMonth.MonthValue.January }, 31 },
                    {   new Scheduler.YearMonth() { Year = 2000, Month = YearMonth.MonthValue.February }, 29 },
                    {   new Scheduler.YearMonth() { Year = 2001, Month = YearMonth.MonthValue.February }, 28 },
                    {   new Scheduler.YearMonth() { Year = 2001, Month = YearMonth.MonthValue.March }, 31 },
                    {   new Scheduler.YearMonth() { Year = 2001, Month = YearMonth.MonthValue.April }, 30 },
                    {   new Scheduler.YearMonth() { Year = YearMonth.YearLimit.Upper, Month = YearMonth.MonthValue.December }, 31 },
                })
                .BDDfy();
        }
    ...
    public class VerifyRangeInvalid
    {
        ...
        public void Execute()
        {
            this.WithExamples(new ExampleTable("yearMonthFrom", "yearMonthTo")
                {
                    {   new YearMonth() { Year = 2000, Month = YearMonth.MonthValue.January }, new YearMonth() { Year = 1999, Month = YearMonth.MonthValue.April } },
                    {   new YearMonth() { Year = 2000, Month = YearMonth.MonthValue.February }, new YearMonth() { Year = 2000, Month = YearMonth.MonthValue.January } },
                })
                .BDDfy();
        }

        public void GivenFromAndToYearMonths(Scheduler.YearMonth yearMonthFrom, Scheduler.YearMonth yearMonthTo)
        {
            this.sutFrom = yearMonthFrom;
            this.sutTo = yearMonthTo;

        }

        public void ThenAnExceptionShouldBeThrown()
        {
            Assert.Throws<System.ArgumentOutOfRangeException>(() => YearMonth.Range(sutFrom, sutTo));
        }
    }
    ...
    public class VerifyRange
    {
        ...
        public void Execute()
        {
            this.WithExamples(new ExampleTable("yearMonthFrom", "yearMonthTo", "expectedMonths")
                {
                    {   new YearMonth() { Year = 2000, Month = YearMonth.MonthValue.January }, new YearMonth() { Year = 2000, Month = YearMonth.MonthValue.January }, 1 },
                    {   new YearMonth() { Year = 2000, Month = YearMonth.MonthValue.January }, new YearMonth() { Year = 2000, Month = YearMonth.MonthValue.April }, 4 },
                    {   new YearMonth() { Year = 2000, Month = YearMonth.MonthValue.February }, new YearMonth() { Year = 2001, Month = YearMonth.MonthValue.January }, 12 },
                })
                .BDDfy();
        }
